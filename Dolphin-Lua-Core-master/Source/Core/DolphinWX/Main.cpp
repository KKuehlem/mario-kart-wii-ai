...
bool DolphinApp::OnInit()
{
	...
	main_frame = new CFrame(nullptr, wxID_ANY, StrToWxStr(scm_rev_str), wxPoint(x, y), wxSize(w, h), m_use_debugger,
	                        m_batch_mode, m_use_logger);
...
void DolphinApp::OnInitCmdLine(wxCmdLineParser &parser)
{
	static const wxCmdLineEntryDesc desc[] = {
	    ...
	    {wxCMD_LINE_OPTION, "e", "exec", "Loads the specified file (ELF, DOL, GCM, ISO, WBFS, CISO, GCZ, WAD)",
	    ...
	    {wxCMD_LINE_OPTION, "id", "id", "The ID of this AI worker", wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL},
	    {wxCMD_LINE_OPTION, "speed", "speed", "The Emulation Speed", wxCMD_LINE_VAL_DOUBLE, wxCMD_LINE_PARAM_OPTIONAL},
...
void DolphinApp::AfterInit()
{
	...
	SConfig::GetInstance().m_EmulationSpeed = emuSpeed;
...
void DolphinApp::InitLanguageSupport()
{
	...
	{
		wxMessageBox(_("The selected language is not supported by your system. Falling back to system default."),
		             _("Error"));
		m_locale.reset(new wxLocale(wxLANGUAGE_DEFAULT));
	}
}
